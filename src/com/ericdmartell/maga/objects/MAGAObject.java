...
public abstract class MAGAObject<T extends MAGAObject<T>> implements Serializable, Cloneable {
	...
	/**
	 * Sometimes we want to keep around an old version of an object because it allows us to accurately dirty cached
	 * indexes, among other things.
	 *
	 * However there is hefty memory overhead and a bit of CPU as well, so this method
	 * also includes some logic for whether to do so.
	 */
